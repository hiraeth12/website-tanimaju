        ...
        <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between md:gap-32 gap-24">
          ...
          >
            ...
            <p className="text-slate-700 text-sm md:text-md mb-8 leading-relaxed text-justify font-body">
              ...
              aplikasi pertanian yang dirancang untuk membantu petani dan
              masyarakat dalam mengelola hasil tani secara efisien dan terarah.
              Melalui aplikasi ini, pengguna dapat dengan mudah melakukan jual
              beli hasil pertanian, memperoleh informasi mengenai kebutuhan tani
              seperti pupuk, bibit, dan perlengkapan, serta mengakses blog
              berbagi informasi yang berisi pengetahuan, pengalaman, dan tips
              seputar pertanian.
            </p>
            <p className="text-slate-700 text-sm md:text-md mb-8 leading-relaxed text-justify font-body">
              Nama <span className="font-bold text-black">TaniMaju</span>{" "}
              berasal dari kombinasi kata{" "}
              <span className="font-bold text-black">“Tani”</span> yang berarti
              pertanian dan <span className="font-bold text-black">“Maju”</span>{" "}
              yang berarti kemajuan, mencerminkan visi untuk mendorong kemajuan
              sektor pertanian di Desa Sukamaju, Bandung, Jawa Barat, melalui
              pemanfaatan teknologi. Dengan hadirnya TaniMaju, pertanian desa
              diharapkan dapat berkembang menjadi lebih modern, mandiri, berdaya
              saing, dan berkelanjutan, sehingga mampu meningkatkan
