...
export function ShareDialog({ slug, productTitle, children }: ShareDialogProps) {
  const [isCopied, setIsCopied] = useState(false);
  const shareUrl = `${window.location.origin}/order/${slug}`;
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: productTitle || "Check this product!",
